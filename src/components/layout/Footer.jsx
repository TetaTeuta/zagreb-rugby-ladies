...
const Footer = () => {
    ...
    return (
        <footer className="bg-grad-start/50 border-t border-text-light/10 mt-auto">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-sm text-text-light/80 mb-4 max-w-md">
                    ...
                    {/* Quick Links */}
                    <div>
                        <h3 className="text-sm text-text-light/80 font-semibold  uppercase tracking-wider mb-4">
                            Quick Links
                        </h3>
                        <ul className="space-y-3">
                            {quickLinks.map((link) => (
                                <li key={link.name}>
                                    <Link
                                        to={link.href}
                                        className="text-sm text-text-light/80 /80 hover: transition-colors"
                                    >
                                        {link.name}
                                    </Link>
                                </li>
                    ...
                    {/* Contact Info */}
                    <div>
                        <h3 className="text-sm text-text-light/80 font-light font-hero uppercase tracking-wider mb-4 leading-[0.85]">
                            GET IN TOUCH
                        </h3>
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center space-x-3">
                                <Mail className="h-4 w-4 text-text-light/80 /60 flex-shrink-0" />
                                <a
                            ...
                            <div className="flex items-center space-x-3">
                                <Phone className="h-4 w-4 text-text-light/80 /60 flex-shrink-0" />
                                <a
                ...
                <div className="mt-8 pt-8 border-t border-text-light/10">
                    <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
                        <div className="text-sm text-text-light/80 /60">
                        ...
                        <div className="flex space-x-6">
                            {legalLinks.map((link) => (
                                <Link
                                    key={link.name}
                                    to={link.href}
                                    className="text-sm text-text-light/80 /60 hover: transition-colors"
                                >
                                    {link.name}
                                </Link>
                            ))}
